...
public class XMLOutputTest extends TestCase {
    public void test1() {
        ...
        logger.info(MessageFactory.createDamageMessage(gemArray, 123));

        logger.info("Game state message");
        logger.info(MessageFactory.createGameStateMessage(gemArray, MessageType.S_GAME_STATE, true, new Player()));
        logger.info("Game state message");
        logger.info(MessageFactory.createGameStateMessage(gemArray, MessageType.S_GAME_STATE, false, new Player()));
    }
